...
import {selectLoggedInUserSavedResponses } from "./authSlice";

function SavedResponses() {
  const userSavedResponse = useSelector(selectLoggedInUserSavedResponses);

  return (
    <div className="max-w-6xl mx-auto p-4">
      <div className="grid grid-cols-1 gap-6">
        {userSavedResponse.map((response, index) => (
